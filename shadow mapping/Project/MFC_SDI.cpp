...
// MFC_SDI.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFC_SDIApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMFC_SDIApp::OnAppAbout)
...
CMFC_SDIApp::CMFC_SDIApp()
{
	...
	SetAppID(_T("MFC_SDI.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMFC_SDIApp

CMFC_SDIApp theApp;


// инициализация CMFC_SDIApp
...
BOOL CMFC_SDIApp::InitInstance()
{
	...
	//Для того, чтобы размеры окна рисования совпадали с размерами экрана, в функции InitInstance()класса C...App необходимо заменить команду
...
// обработчики сообщений CMFC_SDIApp
...
//	ON_COMMAND(ID_BUTTON32771, &CAboutDlg::OnButton32771)
END_MESSAGE_MAP()
...
//
//		m_nTimer = SetTimer(1, 40, 0);  // а теперь физически
//	}
