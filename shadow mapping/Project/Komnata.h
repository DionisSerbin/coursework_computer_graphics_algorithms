...
void CMFC_SDIView::VMatMult(GLmatrix16f M, GLvector4f v)
{
...
GLvoid CMFC_SDIView::ReSizeGLScene(GLsizei width, GLsizei height)		// Resize And Initialize The GL Window
{
...
int CMFC_SDIView::InitGLObjects()										// Initialize Objects
{
...
int CMFC_SDIView::InitGL(GLvoid)										// All Setup For OpenGL Goes Here
{
...
void CMFC_SDIView::DrawGLRoom()										// Draw The Room (Box)
{
...
int CMFC_SDIView::DrawGLScene(GLvoid)									// Main Drawing Routine
{
	GLmatrix16f Minv;
	GLvector4f wlp, lp;
...
void CMFC_SDIView::ProcessKeyboard()									// Process Key Presses
{
	// Spin Object
