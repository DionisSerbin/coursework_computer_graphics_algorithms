...
#include <glut.h>		// Заголовочный файл для GLaux библиотеки
#include <GlEXT.h>		// Заголовочный файл для GLaux библиотеки
#include <WGlEXT.h>		// Заголовочный файл для GLaux библиотеки
